...
class Train_model:
    ...
    def Training(self): #,X_seq,X_img,y,wordtoix
        ...
        #         st = j*split; ed = (j+1)*split
        #         print(st,ed)
        #         model.fit([X_img[st:ed],X_seq[st:ed]], y[st:ed], epochs = 2,
        #                   batch_size = 128,verbose=False)
        #     model.fit([X_img[ed:],X_seq[ed:]], y[ed:], epochs = 2,
...
# train = Train_model() 
# train.Training()  # X_seq,X_img, y,wordtoix
